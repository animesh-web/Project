...
app = Client(session_name="ANYGame",
...
CONTACT_KEYS = InlineKeyboardMarkup([
    [
        InlineKeyboardButton(
            emojis.cat + " GitHub",
            url="https://github.com/animesh-web"
        ),
        InlineKeyboardButton(
            emojis.id + " Telegram",
            url="http://telegram.me/Animeshbhatt007"
        )
    ],
    [
        InlineKeyboardButton(
...
def message_handler(bot: Client, message: Message):
    if message.text == "/start":
        bot.send_message(
            ...
            "with @ANYGameRFBot in any chat you want or click on the **Play** button "
        ...
        bot.send_message(
            message.from_user.id,
            "Feel free to share your thoughts on ANY bot with me.",
    ...
    query.answer(
        results=[InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(
                f"**{query.from_user.first_name}** challenged you in ANY!"
            ),
            description="Tap here to challenge your friends in ANY!",
